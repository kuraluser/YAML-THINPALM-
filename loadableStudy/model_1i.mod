...
subject to Condition114a1 {t in incTB}: wB[t,0] <= wB[t,firstloadingPort];
subject to Condition114a2 {t in decTB}: wB[t,0] >= wB[t,firstloadingPort];
subject to Condition114a3 {t in TBinit}:  initBallast[t] = wB[t,0];

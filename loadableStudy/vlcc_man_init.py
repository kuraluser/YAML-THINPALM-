# -*- coding: utf-8 -*-
"""
Created on Mon Mar 15 14:21:46 2021
...
class Process_man_input(object):
    ...
    def get_stability_param(self,ballast_weight_ = 30000, sf_bm_frac = 0.9, trim_upper = 1, trim_lower = 1):

...
## discharge
set manual within C cross T cross P_dis default {}; 
set balance within C cross T cross P_dis default {}; 
set remain within C cross T cross P_dis default {}; 
set manual1 within C cross P_dis default {}; 
set balance1 within C  cross P_dis default {}; 
set remain1 within C cross P_dis default {}; 
...
#subject to Conditio {(c,t,p) in balance}: w[c,t,p] = 0;
...
## DISCHARGE
# min amount
subject to Condition120a {c in C, t in T, p in P}: -1e5*zw[c,t,p]  <= w[c,t,p];
subject to Condition120b {c in C, t in T, p in P}: w[c,t,p] <= -500*zw[c,t,p];
# min sounding
subject to Condition121a {c in C, t in T, p in P}: 500*zqw[c,t,p]  <= qw[c,t,p]; # 4m sounding
subject to Condition121b {c in C, t in T, p in P}: qw[c,t,p] <= 1e5*zqw[c,t,p];
